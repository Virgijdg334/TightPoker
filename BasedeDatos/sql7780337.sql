...
INSERT INTO `inscripciones` (`nombreUsuario`, `id`) VALUES
('jank3', 1),
('jank3', 4);
...
('jank3', 'Registro de nuevo usuario', '2025-05-24');
...
(1, 'Gran Torneo Anual', 'Casino Madrid', 1000, 122, '2025-06-10', 10000, 150, 'MysteryBounty'),
...
(4, 'Mystery Weekend', 'Casino Sevilla', 3000, 61, '2025-05-30', 30000, 80, 'MysteryBounty'),
...
CREATE TABLE `usuario` (
  ...
  `n_tarjeta` bigint(20) NOT NULL DEFAULT '0',
...
('09856235G', 'Jose Antonio', 'Jimenez Bernaza', 'jank3', '1234', 18, 674987375, 41020, 0, 0),
('12345678A', 'Carlos', 'Mart', 'carlosML', 'pass1234', 30, 612345678, 28001, 1111111111111111, 3000),
('23456789C', 'Pedro', 'Sanz', 'pedroSM', 'pedro2024', 45, 667889900, 29010, 2222222222222222, 0),
('34567890D', 'Laura', 'Fern', 'lauraFG', 'fglaura89', 22, 611223344, 41012, 3333333333333333, 7000),
('45678901E', 'Javier', 'Navarro Pe', 'javiNP', 'jnavpass', 35, 600112233, 3003, 4444444444444444, 16000),
('79085021G', 'Virgilio Jesus', 'Dominguez Gonzalez', 'Virgijdg334', '1234', 22, 618773213, 41009, 0, 0),
('87654321B', 'Luc', 'G', 'luciaGR', 'luciaPass', 27, 698765432, 46002, 5555555555555555, 10000),
('98653412H', 'Alberto', 'Algedano', 'albertito19', '1234', 15, 674984312, 41020, 6666666666666666, 0);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `validar_telefono` BEFORE INSERT ON `usuario` FOR EACH ROW BEGIN
  IF NEW.telefono NOT REGEXP '^[6789][0-9]{8}$' THEN
    SIGNAL SQLSTATE '45000'
    SET MESSAGE_TEXT = 'Número de teléfono inválido. Debe comenzar por 6, 7, 8 o 9 y tener 9 dígitos.';
  END IF;
END
$$
DELIMITER ;
